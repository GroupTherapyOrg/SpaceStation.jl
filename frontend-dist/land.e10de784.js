import"./frontend.4d03b972.js";var e=globalThis,t={},n={},a=e.parcelRequire94c2;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in n){var a=n[e];delete n[e];var o={id:e,exports:{}};return t[e]=o,a.call(o.exports,o,o.exports),o.exports}var l=Error("Cannot find module '"+e+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(e,t){n[e]=t},e.parcelRequire94c2=a);var o=a.register;o("5IQaQ",function(e,t){navigator.platform.toUpperCase().includes("MAC")&&window.top!==window&&fetch("./api/v1/config").then(e=>e.json()).then(e=>{e?.desktop===!0&&window.addEventListener("keydown",e=>{if(!e.metaKey||e.ctrlKey||e.altKey)return;let t="Equal"===e.code||"+"===e.key||"="===e.key?"in":"Minus"===e.code||"-"===e.key?"out":"Digit0"===e.code||"0"===e.key?"reset":null;if(null!=t){e.preventDefault(),e.stopPropagation();try{window.top?.postMessage({type:"spacestation:zoom",action:t},"*")}catch{}}},{capture:!0})}).catch(()=>{})}),o("hmt3d",function(e,t){e.exports=Promise.all([import("a4Bpq"),import("iJpDL")]).then(()=>a("bnHn0"))}),o("aDKOm",function(e,t){e.exports=import("hmOBl").then(()=>a("bJtX0"))}),o("iCed3",function(e,t){e.exports=import("aZARi").then(()=>a("hiQgq"))});var l=a("cNaMA"),r=a("6ha54"),i=a("aLlws");a("5IQaQ");let s=async(e,t)=>{let n=await fetch(e,t);if(!n.ok)throw Error(`${e} \u{2192} ${n.status}`);return await n.text()},c=async(e,t)=>{let n=await fetch(e,t);if(!n.ok)throw Error(`${e} \u{2192} ${n.status}`);return await n.json()},u=e=>(e.split("/").pop()??"").split("\\").pop()??"",d=(e,{action:t="Confirm",danger:n=!1}={})=>new Promise(a=>{let o=document.createElement("dialog");o.className="land-confirm";let l=document.createElement("p");l.textContent=e;let r=document.createElement("div");r.className="buttons";let i=document.createElement("button");i.textContent="Cancel";let s=document.createElement("button");s.textContent=t,s.className=`go ${n?"danger":""}`,r.append(i,s),o.append(l,r),document.body.append(o);let c=e=>{o.close(),o.remove(),a(e)};i.onclick=()=>c(!1),s.onclick=()=>c(!0),o.oncancel=e=>{e.preventDefault(),c(!1)},o.onclick=e=>e.target===o&&c(!1),o.showModal(),i.focus()}),p="spacestation-homebase",h=(()=>{try{return window.self!==window.top}catch(e){return!0}})(),m=h||new URLSearchParams(window.location.search).has("desktop"),b=({classname:e})=>{let[t,n]=(0,l.useState)((0,i.get_color_scheme)());return(0,l.html)`<button
    ...
    </li>`},E=({on_cancel:e,tunneled:t,desktop:n})=>{let a=(0,l.useRef)(n);a.current=n;let o=e=>a.current?`${e}${e.includes("?")?"&":"?"}desktop=1`:e,r=e=>new URL(e,window.location.href).href,s=e=>{var t;let n,a;return null==(a=o((t=r(e),"system"===(n=(0,i.get_color_scheme)())?t:`${t}${t.includes("?")?"&":"?"}scheme=${n}`)))?a:`${a}#homebase=${encodeURIComponent(window.location.origin+window.location.pathname+window.location.search)}`},p=n?"_self":"_blank",h=(e,t)=>f({type:"spacestation:open-workspace",url:o(r(e)),title:t}),[m,$]=(0,l.useState)(null),[y,_]=(0,l.useState)(null),[E,R]=(0,l.useState)([]),[I,T]=(0,l.useState)(C),[L,O]=(0,l.useState)({}),[P,x]=(0,l.useState)({}),[U,A]=(0,l.useState)([]),D=(0,l.useRef)(new Set),N=(0,l.useRef)(new Set),M=(0,l.useCallback)(()=>c("./api/v1/ssh_hosts").then(R).catch(()=>{}),[]);(0,l.useEffect)(()=>{M()},[M]),(0,l.useEffect)(()=>{localStorage.setItem(k,String(I)),fetch(`./api/v1/remote/config?connect_timeout=${encodeURIComponent(I)}`,{method:"POST"}).catch(()=>{})},[I]);let K=(0,l.useCallback)(async e=>{D.current.delete(e);try{let t=await c(`./api/v1/remote/open?host=${encodeURIComponent(e)}`,{method:"POST"});for(O(n=>({...n,[e]:t}));"ready"!==t.state&&"error"!==t.state;){if(await new Promise(e=>setTimeout(e,1500)),D.current.has(e))return;t=await c(`./api/v1/remote/status?host=${encodeURIComponent(e)}`),O(n=>({...n,[e]:t}))}"ready"===t.state&&null!=t.url&&(a.current?h(t.url,e):window.open(s(t.url),"_blank"))}catch(t){if(D.current.has(e))return;O(n=>({...n,[e]:{state:"error",detail:String(t),url:null}}))}},[]),j=(0,l.useCallback)(async e=>{D.current.add(e);try{await fetch(`./api/v1/remote/cancel?host=${encodeURIComponent(e)}`,{method:"POST"})}catch(e){}O(t=>{let n={...t};return delete n[e],n}),A(t=>t.filter(t=>"remote"!==t.kind||t.host!==e))},[]),H=(0,l.useCallback)(async e=>{N.current.delete(e);try{let t=await c(`./api/v1/local/open?path=${encodeURIComponent(e)}`,{method:"POST"});for(x(n=>({...n,[e]:t}));"ready"!==t.state&&"error"!==t.state;){if(await new Promise(e=>setTimeout(e,1e3)),N.current.has(e))return;t=await c(`./api/v1/local/status?path=${encodeURIComponent(e)}`),x(n=>({...n,[e]:t}))}"ready"===t.state&&null!=t.url&&(localStorage.setItem(g,JSON.stringify([e,...v().filter(t=>t!==e)].slice(0,8))),a.current?h(t.url,u(e)||e):window.open(s(t.url),"_blank"))}catch(t){if(N.current.has(e))return;x(n=>({...n,[e]:{state:"error",detail:String(t),url:null}}))}},[]),W=(0,l.useCallback)(async e=>{N.current.add(e);try{await fetch(`./api/v1/local/shutdown?path=${encodeURIComponent(e)}`,{method:"POST"})}catch(e){}x(t=>{let n={...t};return delete n[e],n}),A(t=>t.filter(t=>"local"!==t.kind||t.path!==e))},[]),B=(0,l.useCallback)(async e=>{if(await d(`Shut down the workspace server for ${u(e)}?

Its running notebooks will stop. Files stay on disk and outputs are cached in their .pluto-cache.toml sidecars, so reopening restores everything.`,{action:"Shut down"})){try{await fetch(`./api/v1/local/shutdown?path=${encodeURIComponent(e)}`,{method:"POST"})}catch(e){}x(t=>{let n={...t};return delete n[e],n}),A(t=>t.filter(t=>"local"!==t.kind||t.path!==e))}},[]),J=(0,l.useCallback)(async e=>H(e),[H]),z=(0,l.useCallback)(e=>"remote"===e.kind?j(e.host):"ready"===e.state?B(e.path):W(e.path),[j,B,W]);(0,l.useEffect)(()=>{let e=!0,t=async()=>{let[t,n]=await Promise.all([c("./api/v1/local/list").catch(()=>[]),c("./api/v1/remote/list").catch(()=>[])]);e&&A([...t.map(e=>({kind:"local",key:`local:${e.path}`,name:u(e.path)||e.path,sub:e.path,state:e.state,url:e.url,path:e.path})),...n.map(e=>({kind:"remote",key:`remote:${e.host}`,name:e.host,sub:"SSH remote",state:e.state,url:e.url,host:e.host}))])};t();let n=setInterval(t,3e3);return()=>{e=!1,clearInterval(n)}},[]);let F=(0,l.useRef)(null),q=(0,l.useCallback)(async e=>{F.current=e;try{$(await c(null==e?"./api/v1/browse":`./api/v1/browse?path=${encodeURIComponent(e)}`)),_(null)}catch(e){_(String(e))}},[]);(0,l.useEffect)(()=>{q(null)},[]);let[Y,Q]=(0,l.useState)(!1),V=(0,l.useCallback)(async()=>{Q(!0);try{await Promise.all([M(),q(F.current)])}finally{setTimeout(()=>Q(!1),400)}},[M,q]);(0,l.useEffect)(()=>{let e=()=>{"visible"===document.visibilityState&&V()};window.addEventListener("focus",e),document.addEventListener("visibilitychange",e);let t=setInterval(()=>{"visible"===document.visibilityState&&V()},1e4);return()=>{window.removeEventListener("focus",e),document.removeEventListener("visibilitychange",e),clearInterval(t)}},[V]);let X=(0,l.html)`<button
    ...
    </button>`,G=v(),Z=m?.crumbs??[];return(0,l.html)`<div class="workspace-opener">
        <div class="bubble opener-card">
            <header>
                <img class="land-logo opener-logo" src=${w} alt="SpaceStation" />
            ...
            ${!t&&U.length>0?(0,l.html)`<section>
                      <h2>Running Workspaces</h2>
                      <div class="recent-grid">
                          ${U.map(e=>(0,l.html)`<div class="recent-card running-card ${"ready"===e.state?"":"running-busy"}" key=${e.key}>
            ...
            ${G.length>0?(0,l.html)`<section>
                      <h2>Recent</h2>
                      <div class="recent-grid">
                          ${G.map(e=>(0,l.html)`<button class="recent-card" title=${e} onClick=${()=>J(e)}>
            ...
            <section>
                <h2>Browse ${X}</h2>
                ${null==m?(0,l.html)`<p class="subtitle">loading…</p>`:(0,l.html)`
                          <nav class="breadcrumbs">
                              ${Z.map((e,t)=>(0,l.html)`<button
                                          class="crumb ${t===Z.length-1?"current":""}"
                                          onClick=${()=>q(e.path)}
                                          title=${e.path}
                                      >
                                          ${e.name}</button
                                      >${t>0&&t<Z.length-1?(0,l.html)`<span class="crumb-sep">/</span>`:null}`)}
                          </nav>
                          <div class="dir-grid">
                              ${m.entries.map(e=>(0,l.html)`<button class="dir-pill" title=${e.path} onClick=${()=>q(e.path)}>
                                      <span class="dir-icon">📁</span>${e.name}
                                  </button>`)}
                              ${0===m.entries.length?(0,l.html)`<p class="subtitle">no subfolders</p>`:null}
                          </div>
            ...
            ${!t&&E.length>0?(0,l.html)`<section>
                      ...
                      <div class="dir-grid">
                          ${E.map(e=>{let t=L[e],a=null!=t&&"ready"!==t.state&&"error"!==t.state;return t?.state==="ready"&&null!=t.url?(0,l.html)`<a
                      ...
                      ${Object.entries(L).filter(([e,t])=>"ready"!==t.state&&"error"!==t.state).map(([e,t])=>(0,l.html)`<div class="remote-progress" key=${e}>
                      ...
                      ${Object.values(L).some(e=>"error"===e.state)?(0,l.html)`<p class="opener-error">${Object.entries(L).filter(([e,t])=>"error"===t.state).map(([e,t])=>`${e}: ${t.detail}`).join(" · ")}</p>`:null}
                  </section>`:null}
            ${Object.entries(P).filter(([e,t])=>"ready"!==t.state&&"error"!==t.state).map(([e,t])=>(0,l.html)`<div class="remote-progress" key=${e}>
                        <span class="remote-spinner"></span>
                        <div class="remote-progress-text">
    ...
    </div>`};(()=>{try{return null!=window.frameElement&&null!=window.parent.document.getElementById("land-app")}catch(e){return!1}})()?window.parent.postMessage({type:"spacestation:close-notebook-tab"},location.origin):(0,l.render)((0,l.html)`<${()=>{let[e,t]=(0,l.useState)(null),[n,a]=(0,l.useState)({}),[o,i]=(0,l.useState)(new Set),b=(0,l.useRef)(o);(0,l.useEffect)(()=>{b.current=o},[o]);let[g,v]=(0,l.useState)(!1),[k,S]=(0,l.useState)([]),[C,R]=(0,l.useState)([]),[O,P]=(0,l.useState)(null),[x,U]=(0,l.useState)(null),[A,D]=(0,l.useState)(()=>Number(localStorage.getItem("spacestation sidebar width"))||290),[N,M]=(0,l.useState)(()=>"true"===localStorage.getItem("spacestation sidebar hidden")),[K,j]=(0,l.useState)(()=>"true"===localStorage.getItem("spacestation terminal open")),[H,W]=(0,l.useState)(()=>Number(localStorage.getItem("spacestation terminal height"))||280),[B,J]=(0,l.useState)(()=>Number(localStorage.getItem("spacestation terminal width"))||420),[z,F]=(0,l.useState)(()=>"right"===localStorage.getItem("spacestation terminal dock")?"right":"bottom"),[q,Y]=(0,l.useState)(()=>"light"===localStorage.getItem("spacestation terminal scheme")?"light":"dark"),Q=(0,l.useRef)(!1);K&&(Q.current=!0);let[V,X]=(0,l.useState)(!1),[G,Z]=(0,l.useState)(!1),ee=(0,l.useRef)(null),et=(0,l.useRef)({tabs:[],active:null,terminal_tab:!1}),en=(0,l.useCallback)(e=>{let t;if(e.defaultPrevented||e.isComposing)return;let n=navigator.platform.toUpperCase().includes("MAC"),a=n?e.metaKey&&!e.ctrlKey:e.ctrlKey&&!e.metaKey,o=0,l=-1;if(!e.ctrlKey||e.metaKey||e.altKey||"Tab"!==e.key?!e.ctrlKey||e.metaKey||e.altKey||e.shiftKey||"PageUp"!==e.key&&"PageDown"!==e.key?n&&e.metaKey&&e.shiftKey&&!e.altKey&&!e.ctrlKey&&("BracketLeft"===e.code||"BracketRight"===e.code)?o="BracketLeft"===e.code?-1:1:n&&e.metaKey&&e.altKey&&!e.shiftKey&&!e.ctrlKey&&("ArrowLeft"===e.key||"ArrowRight"===e.key)?o="ArrowLeft"===e.key?-1:1:a&&!e.shiftKey&&!e.altKey&&/^Digit[1-9]$/.test(e.code)&&(l=Number(e.code.slice(5))):o="PageUp"===e.key?-1:1:o=e.shiftKey?-1:1,0===o&&l<0)return;let{tabs:r,active:i,terminal_tab:s}=et.current,c=[...r.map(e=>e.id),...s?["__terminal__"]:[]];if(0!==c.length){if(e.preventDefault(),e.stopPropagation(),l>0)t=c[9===l?c.length-1:Math.min(l,c.length)-1];else{let e=c.indexOf(i??"");t=c[(e+o+c.length)%c.length]}null!=t&&P(t)}},[]);(0,l.useEffect)(()=>(window.addEventListener("keydown",en,!0),()=>window.removeEventListener("keydown",en,!0)),[en]);let ea=(0,l.useCallback)(e=>{try{e?.addEventListener("keydown",en,!0)}catch{}},[en]),[eo,el]=(0,l.useState)(null);(0,l.useEffect)(()=>{if(!G)return;let e=e=>{null==ee.current||ee.current.contains(e.target)||Z(!1)},t=e=>{"Escape"===e.key&&Z(!1)};return document.addEventListener("pointerdown",e),document.addEventListener("keydown",t),()=>{document.removeEventListener("pointerdown",e),document.removeEventListener("keydown",t)}},[G]),et.current={tabs:C,active:O,terminal_tab:K&&"tab"===z};let er=null!=O&&"__terminal__"!==O&&C.find(e=>e.id===O&&"file"!==e.kind);(0,l.useEffect)(()=>{if(!G)return;if(!er)return void el(null);let e=!0;return c(`./api/v1/notebook/env?id=${encodeURIComponent(er.id)}`).then(t=>e&&el({id:er.id,managed:t?.managed===!0,command:t?.command})).catch(()=>e&&el({id:er.id,managed:!1})),()=>{e=!1}},[G,er?.id]);let ei=(0,l.useRef)(!1),es=(0,l.useRef)(null);if(null==es.current){let e=window.location.hash.match(/[#&]homebase=([^&]+)/);if(e)try{es.current=decodeURIComponent(e[1])}catch(e){}}let[ec,eu]=(0,l.useState)(!1),[ed,ep]=(0,l.useState)(/^\/w\/[^/]+\//.test(window.location.pathname)),[eh,em]=(0,l.useState)(m),[eb,ef]=(0,l.useState)(!1),[ew,eg]=(0,l.useState)(r.pluto_file_extensions);(0,l.useEffect)(()=>{c("./api/v1/config").then(e=>{eu(!!(e&&e.tunneled)),em(m||!!(e&&e.desktop)),ep(!!(e&&e.hub&&null!=e.wid)),Array.isArray(e?.notebook_extensions)&&e.notebook_extensions.length>0&&eg(e.notebook_extensions)}).catch(()=>{})},[]);let ev=(0,l.useCallback)(e=>(0,r.has_pluto_file_extension)(e,ew),[ew]);(0,l.useEffect)(()=>{g&&(window.name=p)},[g]),(0,l.useEffect)(()=>{document.title=g?"SpaceStation (launcher)":e?.root?`SpaceStation \u{2014} ${u(e.root)}`:"SpaceStation"},[g,e]);let e$=(0,l.useCallback)(()=>{if(eh&&h)return void f({type:"spacestation:focus-launcher"});if(eh&&null!=es.current){window.location.href=es.current;return}if(!ed&&(ec||eh))return void fetch("./api/v1/workspace/close",{method:"POST"}).finally(()=>window.location.reload());try{if(window.opener&&!window.opener.closed)return void window.opener.focus()}catch(e){}if(ed&&null==es.current&&(es.current=new URL("../../",window.location.href).href),es.current){let e=null;try{e=window.open("",p)}catch(e){}if(null==e)return void window.open(es.current,p);let t=!1;try{t="about:blank"===e.location.href}catch(e){}if(t)try{e.location.href=es.current}catch(e){}try{e.focus()}catch(e){}return}X(!0)},[ec,eh,ed]),[ey,ek]=(0,l.useState)([]),[eS,eC]=(0,l.useState)(null),e_=(0,l.useRef)(null),[eE,eR]=(0,l.useState)(null),eI=(0,l.useRef)(-1);(0,l.useEffect)(()=>{let t=e?.root??null;if(null==t||e_.current===t)return;let n=(e=>{if("string"!=typeof e||0===e.length)return[];try{let t=JSON.parse(localStorage.getItem($)??"{}"),n=t&&"object"==typeof t&&!Array.isArray(t)?t[e]:null;if(!Array.isArray(n)){let e=JSON.parse(localStorage.getItem(y)??"[]");Array.isArray(e)&&e.length>0&&(n=e,localStorage.removeItem(y))}if(!Array.isArray(n))return[];return n.filter(e=>e&&"string"==typeof e.tid).map(e=>({tid:e.tid,label:e.label??"Terminal"}))}catch{return[]}})(t);e_.current=t,ek(n),eC(n.length?n[n.length-1].tid:null);let a=n.map(e=>parseInt(String(e.label??"").replace(/[^0-9]/g,""),10)).filter(e=>!isNaN(e));eI.current=a.length?Math.max(...a):0,eR(t)},[e?.root]),(0,l.useEffect)(()=>{localStorage.setItem("spacestation sidebar width",String(A)),localStorage.setItem("spacestation sidebar hidden",String(N)),localStorage.setItem("spacestation terminal open",String(K)),localStorage.setItem("spacestation terminal height",String(H)),localStorage.setItem("spacestation terminal scheme",q),localStorage.setItem("spacestation terminal width",String(B)),localStorage.setItem("spacestation terminal dock",z)},[A,N,K,H,B,z,q]),(0,l.useEffect)(()=>{let t=e?.root??null;null!=t&&e_.current===t&&eE===t&&((e,t)=>{if("string"!=typeof e||0===e.length)return;let n={};try{let e=JSON.parse(localStorage.getItem($)??"{}");e&&"object"==typeof e&&!Array.isArray(e)&&(n=e)}catch{}n[e]=t.map(e=>({tid:e.tid,label:e.label})),localStorage.setItem($,JSON.stringify(n))})(t,ey)},[ey,eE,e?.root]),(0,l.useEffect)(()=>{let e=e=>{let t=!1;for(let e of T.values())if(e){t=!0;break}t&&(e.preventDefault(),e.returnValue="")};return window.addEventListener("beforeunload",e),()=>window.removeEventListener("beforeunload",e)},[]);let eT=(0,l.useCallback)(e=>{e.preventDefault();let t="bottom"===z;document.body.classList.add(t?"resizing-v":"resizing");let n=e=>t?W(Math.max(120,Math.min(window.innerHeight-220,window.innerHeight-e.clientY-12))):J(Math.max(240,Math.min(window.innerWidth-420,window.innerWidth-e.clientX-12))),a=()=>{document.body.classList.remove("resizing-v"),document.body.classList.remove("resizing"),window.removeEventListener("pointermove",n),window.removeEventListener("pointerup",a)};window.addEventListener("pointermove",n),window.addEventListener("pointerup",a)},[z]),eL=(0,l.useCallback)((e,t,n="notebook")=>{R(a=>a.some(t=>t.id===e)?a:[...a,{id:e,path:t,kind:n}]),P(e)},[]),eO=(0,l.useCallback)(e=>{eL(`file:${e}`,e,"file")},[eL]),eP=(0,l.useCallback)((t={})=>{if(e?.root==null||e_.current!==e.root)return;eI.current+=1;let n="term-"+Math.random().toString(36).slice(2,12),a={tid:n,label:t.label??`Terminal ${eI.current}`};t.notebook_env&&(a.notebook_env=t.notebook_env),ek(e=>[...e,a]),eC(n),j(!0)},[e?.root]),ex=(0,l.useCallback)(e=>{fetch(`./api/v1/terminal/close?tid=${encodeURIComponent(e)}`,{method:"POST"}).catch(()=>{}),ek(t=>{let n=t.filter(t=>t.tid!==e);return eC(t=>t===e?n.length?n[n.length-1].tid:null:t),n})},[]);(0,l.useEffect)(()=>{K&&e?.root!=null&&e_.current===e.root&&eE===e.root&&0===ey.length&&eP()},[K,ey.length,eE,e?.root]);let eU=(0,l.useCallback)(async e=>{try{let{entries:t}=await c(`./api/v1/workspace/listing?path=${encodeURIComponent(e)}`);a(n=>({...n,[e]:t}))}catch(t){if(!b.current.has(e))return;a(n=>({...n,[e]:[{name:"…",path:`${e}/\u{2026}`,type:"unreadable",detail:String(t)}]}))}},[]),eA=(0,l.useCallback)(e=>{let t=!b.current.has(e);i(n=>{let a=new Set(n);return t?a.add(e):a.delete(e),b.current=a,a}),t&&eU(e)},[eU]),[eD,eN]=(0,l.useState)(null),[eM,eK]=(0,l.useState)(null),ej=(0,l.useRef)(!1),eH=(0,l.useCallback)(async()=>{if(ej.current)return;ej.current=!0;let e=new AbortController,n=setTimeout(()=>e.abort(),15e3),o=e.signal;try{let e=await fetch("./api/v1/workspace",{signal:o});if(404===e.status){eN(null),v(!0),t(null),U(null);return}if(504===e.status){let t=await e.json().catch(()=>({}));eN(e=>({since:e?.since??Date.now(),detail:String(t.detail??"")}))}else if(e.ok){eN(null),v(!1),t(await e.json());let n=[...b.current],o=await Promise.all(n.map(e=>c(`./api/v1/workspace/listing?path=${encodeURIComponent(e)}`).then(t=>[e,t.entries]).catch(()=>[e,null])));a(e=>{let t={...e};for(let[e,n]of o)null!=n&&(t[e]=n);return t})}else throw Error(`workspace request failed: ${e.status}`);let n=await fetch("./api/v1/notebooks",{signal:o});if(503===n.status||504===n.status){let e=await n.json().catch(()=>({}));eK(t=>({kind:e.workspace_down?"down":"busy",since:t?.since??Date.now(),detail:String(e.detail??"")})),U(null);return}if(!n.ok)throw Error(`notebooks request failed: ${n.status}`);let l=await n.json();eK(null),S(l),ei.current||(ei.current=!0,l.forEach(e=>eL(e.notebook_id,e.path))),U(null)}catch(e){e?.name==="AbortError"?eK(e=>({kind:"busy",since:e?.since??Date.now(),detail:"no answer within 15 seconds"})):e instanceof TypeError?ef(!0):U(String(e))}finally{clearTimeout(n),ej.current=!1}},[eL]),eW=(0,l.useCallback)(async()=>{let t=e?.root;if(null!=t){eK(e=>({kind:"busy",since:e?.since??Date.now(),detail:"restarting the workspace server…"}));try{let e=await c(`./api/v1/local/restart?path=${encodeURIComponent(t)}`,{method:"POST"});for(;"ready"!==e.state&&"error"!==e.state;)await new Promise(e=>setTimeout(e,1e3)),e=await c(`./api/v1/local/status?path=${encodeURIComponent(t)}`);"ready"===e.state?window.location.reload():U(String(e.detail??"the workspace server did not start"))}catch(e){U(String(e))}}},[e]);(0,l.useEffect)(()=>{eH();let e=setInterval(eH,1e4);return()=>clearInterval(e)},[]),(0,l.useEffect)(()=>{let e=()=>{"visible"===document.visibilityState&&eH()};return window.addEventListener("online",e),document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),()=>{window.removeEventListener("online",e),document.removeEventListener("visibilitychange",e),window.removeEventListener("focus",e)}},[eH]),(0,l.useEffect)(()=>{if(!eb)return;let e=!1,t=null,n=1e3,a=async()=>{if(!e){try{if((await fetch("./ping",{cache:"no-store"})).ok)return void window.location.reload()}catch{}n=Math.min(1.5*n,5e3),e||(t=setTimeout(a,n))}};return t=setTimeout(a,700),()=>{e=!0,null!=t&&clearTimeout(t)}},[eb]);let eB=(0,l.useCallback)(e=>{e.preventDefault(),document.body.classList.add("resizing");let t=e=>D(Math.max(180,Math.min(560,e.clientX-12))),n=()=>{document.body.classList.remove("resizing"),window.removeEventListener("pointermove",t),window.removeEventListener("pointerup",n)};window.addEventListener("pointermove",t),window.addEventListener("pointerup",n)},[]),eJ=(0,l.useCallback)(async e=>{try{let t=await s(`./open?path=${encodeURIComponent(e)}`,{method:"POST"});eL(t,e),eH()}catch(e){U(String(e))}},[eL,eH]),ez=(0,l.useCallback)(async()=>{if(null==e)return;let t=prompt("Notebook file name (created in the workspace):","new notebook.jl");if(null!=t)try{let n=await s("./new",{method:"POST"}),a=`${e.root}/${ev(t)?t:t+".jl"}`;await s(`./move?id=${encodeURIComponent(n)}&newpath=${encodeURIComponent(a)}`,{method:"POST"}),eL(n,a),eH()}catch(e){U(String(e))}},[e,eL,eH,ev]),eF=(0,l.useCallback)(async e=>{if(e.startsWith("file:")){let t=e.slice(5);if(T.get(t)&&!await d("This file has unsaved changes. Close anyway?",{action:"Close without saving",danger:!0}))return;T.delete(t)}R(t=>{let n=t.filter(t=>t.id!==e);return P(t=>t===e?n.length>0?n[n.length-1].id:null:t),n})},[]);(0,l.useEffect)(()=>{let e=e=>{if(e.origin!==location.origin||e.data?.type!=="spacestation:close-notebook-tab")return;let t=[...document.querySelectorAll("#frames iframe")].find(t=>t.contentWindow===e.source),n=null==t?void 0:t.dataset.tabId;null!=n&&eF(n)};return window.addEventListener("message",e),()=>window.removeEventListener("message",e)},[eF]);let eq=(0,l.useCallback)(async t=>{let n=prompt(`New file in ${u(t)}/ \u{2014} a name ending in .jl or .plutojl becomes a Pluto notebook:`,"notebook.jl");if(null==n||""===n.trim())return;let a=`${t}/${n.trim()}`;try{if(ev(n.trim())){let e=await s("./new",{method:"POST"});await s(`./move?id=${encodeURIComponent(e)}&newpath=${encodeURIComponent(a)}`,{method:"POST"}),eL(e,a)}else await c(`./api/v1/file/new?path=${encodeURIComponent(a)}`,{method:"POST"}),eO(a);null==e||t===e.root||b.current.has(t)?eU(t):eA(t),eH()}catch(e){U(String(e))}},[eL,eO,eH,eA,eU,e,ev]),eY=(0,l.useCallback)(async e=>{let t="notebook"===e.type?"notebook (it will be shut down if running; its output cache is deleted too)":"file";if(await d(`Delete ${e.name}?

This permanently deletes the ${t}. There is no trash.`,{action:"Delete",danger:!0}))try{await c(`./api/v1/file/delete?path=${encodeURIComponent(e.path)}`,{method:"POST"}),R(t=>t.filter(t=>t.path!==e.path)),T.delete(e.path),eH()}catch(e){U(String(e))}},[eH]),eQ=(0,l.useCallback)(async e=>{if(await d("Shut down this notebook session? The file stays on disk; outputs are cached.",{action:"Shut down"}))try{await s(`./shutdown?id=${encodeURIComponent(e)}`,{method:"POST"}),eF(e),eH()}catch(e){U(String(e))}},[eF,eH]),eV=K&&"tab"===z,eX=(0,l.useCallback)(()=>{let e=!K;j(e),e&&"tab"===z&&P("__terminal__"),e||P(e=>"__terminal__"===e?null:e)},[K,z]),eG=(0,l.useCallback)(()=>{let e="bottom"===z?"right":"right"===z?"tab":"bottom";"tab"===e?(j(!0),P("__terminal__")):"tab"===z&&P(e=>"__terminal__"===e?null:e),F(e)},[z]),eZ=t=>(0,l.html)`
        <div class="terminal-tabs">
            <div class="terminal-tab-scroller">
                ${(e_.current===e?.root?ey:[]).map(e=>(0,l.html)`<div class="tab terminal-tab ${e.tid===eS?"active":""}" key=${e.tid}>
...
Its running notebooks stop; this terminal, the launcher and other workspaces keep running.`:"Shut down the SpaceStation server?\n\nRunning notebooks and the integrated terminal will stop. SSH remote servers keep running and can be reattached later.",{action:"Shut down"}))return;fetch("./api/v1/shutdown",{method:"POST"}).catch(()=>{});let e=async()=>{try{if(ed){let e=await fetch("./api/v1/notebooks",{cache:"no-store"});return 502!==e.status&&503!==e.status&&504!==e.status}return await fetch("./ping",{method:"GET",cache:"no-store"}),!0}catch{return!1}},t=Date.now()+(ed?15e3:8e3);for(;Date.now()<t;)if(await new Promise(e=>setTimeout(e,400)),!await e()){if(ed)return void eK({kind:"down",since:Date.now(),detail:"shut down from this page"});document.body.innerHTML='<div style="font: 15px/1.6 system-ui, sans-serif; padding: 3rem; text-align: center; color: #888">SpaceStation has shut down. You can close this tab.</div>';return}U("Shutdown was requested, but the server is still responding — it may not have shut down.")},[ed]);return g||V?(0,l.html)`<${E} on_cancel=${g?null:()=>X(!1)} tunneled=${ec} desktop=${eh} />`:(0,l.html)`
        <div id="land">
            ...
            ${null!=eD&&!eb?(0,l.html)`<div class="workspace-status busy" role="status" aria-live="polite" title=${eD.detail}>
                      <span>The filesystem that holds these files is not answering (${Math.max(1,Math.round((Date.now()-eD.since)/1e3))}s) — the file list will catch up; the terminal and notebooks keep working.</span>
                  </div>`:null}
            ${null!=eM&&!eb?(0,l.html)`<div class="workspace-status ${eM.kind}" role="status" aria-live="polite">
                      ${"down"===eM.kind?(0,l.html)`<span>The server for this workspace stopped answering. Its notebooks are gone with it; the sidebar and terminal are fine.</span>
                                <button onClick=${eW}>Restart workspace server</button>`:(0,l.html)`<span>The server for this workspace is busy (${Math.max(1,Math.round((Date.now()-eM.since)/1e3))}s) — notebooks will catch up; the sidebar and terminal keep working.</span>`}
                  </div>`:null}
            ${N?(0,l.html)`<button id="sidebar-reopen" title="Show sidebar" onClick=${()=>M(!1)}>☰</button>`:(0,l.html)`<aside style=${`width: ${A}px`}>
                <header class="bubble">
                    <div class="header-row">
                        <button class="land-logo-button" title="Back to homebase (open &amp; manage workspaces)" onClick=${e$}>
                            <img class="land-logo" src=${w} alt="SpaceStation" />
                        </button>
...
${eo.command}`:"This notebook has no Pluto-managed environment yet: it has not run, or it activates its own with Pkg.activate"}
                                              onClick=${()=>{Z(!1),er&&eP({label:`env: ${u(er.path)}`,notebook_env:er.id})}}
                                          >
                                              <span class="menu-icon terminal"></span>Open env in terminal
                                          </button>
                                          <button class="header-menu-item danger" role="menuitem" onClick=${()=>{Z(!1),e0()}}><span class="menu-icon power"></span>Shut down server</button>
                                      </div>`:null}
                            </div>
                ...
                <section class="files bubble">
                    <h2>
                        ...
                        ${null==e?null:(0,l.html)`<button class="row-action h2-action" title="New notebook or file in the workspace root" onClick=${()=>eq(e.root)}>+</button>`}
                    </h2>
                    <ul class="tree">
                        ${null==e?null:e.entries.map(e=>(0,l.html)`<${_}
                                          key=${e.path}
                                          entry=${e}
                                          listings=${n}
                                          expanded=${o}
                ...
                <footer>
                    <button class="new-notebook" onClick=${ez}>+ New notebook</button>
                </footer>
            </aside>`}
            ${N?null:(0,l.html)`<div id="sidebar-resizer" onPointerDown=${eB}></div>`}
            <main>
                <div class="main-split ${z}">
                    <div class="editor-card">
                        <nav id="tabs">
                            <div class="tab-scroller">
                                ${C.map(e=>(0,l.html)`<div class="tab ${e.id===O?"active":""}" key=${e.id}>
                                        <button class="title" title=${e.path} onClick=${()=>P(e.id)}>${u(e.path)}</button>
                                        <button class="close" title="Close tab (notebook keeps running)" onClick=${()=>eF(e.id)}>×</button>
                                    </div>`)}
                                ${eV?(0,l.html)`<div class="tab terminal-tab ${"__terminal__"===O?"active":""}" key="__terminal__">
                            ...
                            <button class="terminal-toggle ${K?"active":""}" title="Toggle the integrated terminal (runs in the workspace folder)" onClick=${eX}>⌨ Terminal</button>
                            ${K?(0,l.html)`<button
                        ...
                        <div id="frames">
                            ${C.map(e=>"file"===e.kind?(0,l.html)`<div key=${e.id} class="pane ${e.id===O?"active":""}">
                                      ...
                                      ></iframe>`)}
                            ${eV?(0,l.html)`<div class="pane terminal-area-pane ${"__terminal__"===O?"active":""}">
                                      ${eZ(eV&&"__terminal__"===O)}
                                  </div>`:null}
                            ${0===C.length&&"__terminal__"!==O?(0,l.html)`<div class="empty-state">
